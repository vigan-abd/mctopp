 ...
 */
const sql = (records) => {
  const csvFile = `${__dirname}/output/${path.basename(file)}.sql`;
  let content = `
  INSERT INTO results (avgScore, avgTime, bestScore, params_sa_seed, params_sa_max_iter, params_sa_cool_fact, params_sa_min_swap, params_sa_max_swap, params_sa_max_del, params_sa_max_ins, params_sa_init_sol, params_sa_cool_func, bestTime, bestIters, bestSol) VALUES\n`;
